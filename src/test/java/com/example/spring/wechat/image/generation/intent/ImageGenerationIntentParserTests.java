package com.example.spring.wechat.image.generation.intent;
...
class ImageGenerationIntentParserTests {
    ...
    void detectsNaturalLanguageImageGenerationRequest() {
        assertThat(parser.matches("帮我生成一张赛博朋克风格的橘猫图片")).isTrue();
        assertThat(parser.extractPrompt("帮我生成一张赛博朋克风格的橘猫图片"))
                .isPresent()
                .get()
                .isEqualTo("赛博朋克风格的橘猫图片");
    }
